...
public class VistaBuscadorFacturas extends JFrame {
	...
	private JTextField txtFacturaBuscar;
	...
	public VistaBuscadorFacturas() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 469, 398);
		setTitle("InformatikAlmi | Buscador Facturas");
		...
		txtFacturaBuscar = new JTextField();
		txtFacturaBuscar.setColumns(10);
		panelSuperior.add(txtFacturaBuscar);
	...
	public JTextField getTxtFacturaBuscar() {
		return txtFacturaBuscar;
	}

	public void setTxtFacturaBuscar(JTextField txtFacturaBuscar) {
		this.txtFacturaBuscar = txtFacturaBuscar;
	}
