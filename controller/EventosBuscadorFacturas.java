...
public class EventosBuscadorFacturas {
	private VistaBuscadorFacturas vistaBuscadorFacturas;
	private EventosCesta eventosCesta;
	private ConexionDB conexionDB;
	private int clienteSeleccionado;
	private List<Producto> listaProductos;
	
	public EventosBuscadorFacturas(VistaBuscadorFacturas vistaBuscadorFacturas, EventosCesta eventosCesta) {
		this.vistaBuscadorFacturas = vistaBuscadorFacturas;
	...
	public void registrarEventos() {
		vistaBuscadorFacturas.getBtnBuscar().addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String dni = vistaBuscadorFacturas.getTxtFacturaBuscar().getText();
				mostrarResultadoClientes(dni);
			}
		});
		
		vistaBuscadorFacturas.getBtnCerrar().addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				vistaBuscadorFacturas.setVisible(false);
			}
		});
	}
	
	public void limpiar() {
		vistaBuscadorFacturas.getPanelListaClientes().removeAll();
		vistaBuscadorFacturas.getPanelListaClientes().revalidate();
		vistaBuscadorFacturas.getPanelListaClientes().repaint();
    }
...
//                    }	
        ...
        vistaBuscadorFacturas.getPanelListaClientes().add(labelCliente);
        vistaBuscadorFacturas.getPanelListaClientes().add(btnSeleccionar);
        vistaBuscadorFacturas.getPanelListaClientes().revalidate();
        vistaBuscadorFacturas.getPanelListaClientes().repaint();
    }
